...
INSERT INTO products (store_product_id, type, name, description, price_cents, currency) VALUES
  ...
  ('all_packs', 'packs', 'All Theme Packs', 'Unlock all current and future premium theme packs', 899, 'EUR'),
  ('packs_no_ads', 'bundle', 'Ultimate Bundle', 'All theme packs + ad-free experience - Best value!', 999, 'EUR');
